...
Revision ID: 9d4a730224ef
Revises: 
Create Date: 2022-12-10 00:30:46.093007
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('active_eng', 'archived_eng', 'draft_eng', 'deleted_eng', 'active_ru', 'archived_ru', 'draft_ru', 'deleted_ru', name='orderstatus'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
