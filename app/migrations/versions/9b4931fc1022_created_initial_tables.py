...
Revision ID: 9b4931fc1022
Revises: 646f62224d9e
Create Date: 2022-12-09 23:53:46.551881
...
revision = '9b4931fc1022'
down_revision = '646f62224d9e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('active_eng', 'archived_eng', 'draft_eng', 'deleted_eng', 'active_ru', 'archived_ru', 'draft_ru', 'deleted_ru', name='dealstatus'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    ...
    op.alter_column('category', 'game_id',
